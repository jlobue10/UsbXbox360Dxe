/** @file
  ...
  Note: bytes 32/33 rest at 0x7F and read 0xFF in occasional degenerate
  transition frames (bytes 5-8 zeroed); they are NOT the right stick --
  a field capture with the right stick held deflected during button
  presses showed the movement at 16/17 in XInput mode too (issue #23)
